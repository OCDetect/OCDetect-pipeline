...
for file in os.listdir(origin_path):
    if file.endswith(".csv") and file.startswith("OCDetect_"): # only the recordings
        ...
        df['datetime'] = pd.to_datetime(df['datetime']) # convert datetime to datatype datetime
...
# 0 2022-04-05 09:17:10.000 -5.965994 -2.998565  ... -0.605978 -0.686612          NaN
# 1 2022-04-05 09:17:10.020 -4.608018 -3.257227  ... -0.605978 -0.686612          NaN
# 2 2022-04-05 09:22:10.000 -4.608018 -3.257227  ... -0.605978 -0.686612          1.0
# 3 2022-04-05 09:23:10.020 -4.608018 -3.257227  ... -0.605978 -0.686612          NaN
# 4 2022-04-05 09:26:10.020 -4.608018 -3.257227  ... -0.605978 -0.686612          1.0
# 5 2022-04-05 09:29:10.020 -4.608018 -3.257227  ... -0.605978 -0.686612          NaN
# 6 2022-04-05 09:30:10.020 -4.608018 -3.257227  ... -0.605978 -0.686612          1.0
#
# [7 rows x 8 columns]
#                  datetime     acc x     acc y  ...    gyro y    gyro z  user yes/no
# 8 2022-04-05 09:49:10.020 -4.608018 -3.257227  ... -0.605978 -0.686612          NaN
# 9 2022-04-05 09:52:10.020 -4.608018 -3.257227  ... -0.605978 -0.686612          1.0
#
# [2 rows x 8 columns]
